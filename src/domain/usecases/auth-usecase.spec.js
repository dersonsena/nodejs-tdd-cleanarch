...
const makeSut = () => {
  ...
  const updateAccessTokenRepositorySpy = makeUpdateAccesssTokenRepositorySpy()
...
const makeUpdateAccesssTokenRepositorySpy = () => {
...
const makeLoadUserRepositorySpyWithError = () => {
  class LoadUserByEmailRepositorySpy {
    async load () {
      throw new Error()
    }
...
describe('Auth Use Case', () => {
  ...
  test('Should throw if any dependency throws', async () => {
    ...
    const suts = [].concat(
      new AuthUseCase({
        loadUserByEmailRepository: makeLoadUserRepositorySpyWithError()
      }),
      new AuthUseCase({
        loadUserByEmailRepository,
